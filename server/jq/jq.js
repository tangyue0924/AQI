// // JavaScript Document
// let day = new Date("2021-2-29");

// function RunGLNL() {
//     return SolarTerm(day);
// }
...
//     else return CnMonthofDate(DateGL) + "\n" + CnDayofDate(DateGL);
// }
...
//         M == 23 ? M = 0 : M++;
//     }
//     if (`${BeginTime.getFullYear()}${BeginTime.getMonth()}${BeginTime.getDate()}` === `${DateGL.getFullYear()}${DateGL.getMonth()}${DateGL.getDate()}`) {
//         return {
//             isJieqi: true,
//             text: SolarTermPinyin[M],
//             cn: SolarTermStr[M]
//         }
//     } else {
//         return {
//             isJieqi: false,
//             text: CnDateofDateStr(DateGL)
//         };
//     }
...
function runLunar() {
    ...
    if (lunar.term) {
        ...
        // var CnMonthStr = new Array("正", "二", "三", "四", "五", "六", "七", "八", "九", "十", "冬", "腊");

        let monthName = lunar.lunarMonthName;
        if (lunar.lunarMonthName === "十一月") monthName = "冬月";
        else if (lunar.lunarMonthName === "十二月") monthName = "腊月";
        else if (lunar.lunarMonthName === "一月") monthName = "正月";
